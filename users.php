          ...
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="message.php" class="list-group-item"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> Messages <span class="badge"><?php
                                                                                                                                                                ...
                                                                                                                                                                ?></span></a>
              <a href="users.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Users <span class="badge"><?php



                                                                                                                                                                            $sql = "SELECT COUNT(status) FROM `patient` WHERE status='confimed'";
                                                                                                                                                                            $result = mysqli_query($conn, $sql);
                                                                                                                                                                            $row = mysqli_fetch_array($result);
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <form action="user_process.php" method="post" autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="user_name" class="form-control" placeholder="Enter User_Name" value="<?php echo $user_name ?>" required>
                  </div>
              ...
              <div class="modal-footer">
                <a href="users.php" type="button" class="btn btn-default" data-dismiss="modal">Close</a>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                  ...
                  $sql = "SELECT * FROM user WHERE user_type='user' ORDER BY id DESC";
                  ...
                  if ($result = mysqli_query($conn, $sql)) {
                    if (mysqli_num_rows($result) > 0) {
                      while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo    "<td>" . $row['date'] . "</td>";
                        echo    "<td> <a href='user_delete.php?id=" . $row['id'] . "><button type='submit' class='btn btn-danger btn-xs' name='delect' >Delete</button></a> </td>";
